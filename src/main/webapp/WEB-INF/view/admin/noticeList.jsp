                                    ...
                                    <div class="d-flex flex-column align-items-center mt-4">
                                        ...
                                        <div class="pagination mb-3">
                                            <c:if test="${notices.hasPrevious()}">
                                                <a href="/admin/noticeList?page=${currentPage - 2}&size=${pageSize}" class="btn btn-primary">&laquo; 이전</a>
                                            </c:if>
                                            <c:forEach begin="1" end="${notices.totalPages}" var="i">
                                                <a href="/admin/noticeList?page=${i - 1}&size=${pageSize}" class="btn ${i == currentPage ? 'btn-secondary active' : 'btn-light'}">${i}</a>
                                            </c:forEach>
                                            <c:if test="${notices.hasNext()}">
                                                <a href="/admin/noticeList?page=${currentPage}&size=${pageSize}" class="btn btn-primary">다음 &raquo;</a>
                                            </c:if>
                                        </div>
