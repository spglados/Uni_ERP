    ...
    <div class="card-body">
                ...
                <c:forEach var="employee" items="${employees}">
                    <div class="col-md-4">
                        <div class="form-check employee-checkbox">
                            <input class="form-check-input" type="checkbox" name="empNos" value="${employee.uniqueEmployeeNumber}" id="emp${employee.uniqueEmployeeNumber}">
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                ...
                <button type="button" class="btn btn-secondary" id="refreshBtn">새로 고침</button>
            </div>
