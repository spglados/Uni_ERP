    ...
    <div class="shadow p-3 mb-5 bg-white rounded" style="height: 83%; margin-top: 26px;">
        ...
        <div class="table-container">
            ...
            <table class="table table-bordered table-striped" id="materialList">
                ...
                <tbody>
                <c:forEach var="material" items="${materialManagementList}">
                    <tr>
                        ...
                        ${material.lastEnterDate != null ? material.lastEnterDate : '없음'}
                        </td>
                        <td>
                            <span style="color: ${material.imminent ? 'red' : 'black'};">
                                ${material.imminent ? '<i class="fas fa-clock" style="color: black;"></i>' : '<i class="fas fa-calendar"></i>'}
                                ${material.expirationDate != null ? material.expirationDate : '없음'}
                            </span>
                        </td>
                        <td>${material.stockCycle > 0 ? material.stockCycle : '-'}<c:if test="${material.stockCycle > 0}">일</c:if></td>
