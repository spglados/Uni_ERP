...
<main class="main-container">
	<div class="signup-container">
		...
		<input type="text" name="name" id="name" placeholder="이름" required> <span id="nameMessage" class="name-Message"></span> <input type="password" name="password"
			id="password" placeholder="비밀번호" required> <span id="passwordMessage" class="password-message"></span> <input type="password" name="confirm_password"
			id="confirm_password" placeholder="비밀번호 확인" required> <span id="passwordCheckMessage" class="password-message"></span>

		<div>
			<input type="email" id="email" name="email" placeholder="이메일 주소" required> <span id="emailMessage" class="email-message"></span>
		...
		<p>
			<input id="phone" type="tel" name="phone" placeholder="핸드폰 번호" required> <span id="phoneMessage" class="phone-message"></span>
			...
			<br /> <input id="phone2" type="text" name="phone2" title="인증번호 입력" disabled required /><br>
