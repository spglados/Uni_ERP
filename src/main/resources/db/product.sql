...
VALUES
    ('천일염', 1000, 1.0, 1.0, 'KG', '최이제', '2024-10-12', '2024-12-01', 1, 1, 'true', '2024-10-21'),
    ('총각 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2024-10-13', '2024-10-18', 2, 2, 'true', '2024-10-19'),
    ('처녀 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2024-10-14', '2024-11-02', 2, 2, 'true', '2024-10-21'),
    ('아저씨 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2024-10-15', '2024-11-03', 2, 2, 'true', '2024-10-20'),
    ('개쩌는 돼지고기', 15000, 1.5, 1.5, 'KG', '장건우', '2024-10-14', '2024-11-05', 3, 3, 'true', '2024-10-21'),
    ('딱딱 두부', 2000, 1.0, 1.0, 'EA', '장건우', '2024-10-14', '2024-11-01', 4, 4, 'true', '2024-10-21'),
    ('그냥 두부', 2000, 1.0, 1.0, 'EA', '이건우', '2024-10-14', '2024-11-06', 4, 4, 'true', '2024-10-02'),
    ('매운 고춧가루', 3000, 0.1, 0.1, 'KG', '이건우', '2024-10-15', '2025-01-01', 5, 5, 'true', '2024-10-21'),
    ('개매운 고춧가루', 3000, 0.1, 0.1, 'KG', '강경훈', '2024-10-15', '2025-11-01', 5, 5, 'true', '2024-10-21'),
    ('평양 마늘', 1000, 200.0, 200.0, 'G', '김남철', '2024-10-16', '2024-12-15', 6, 6, 'true', '2024-10-21'),
    ('이제 된장', 4000, 0.3, 0.3, 'KG', '방민석', '2024-10-17', '2024-12-20', 7, 7, 'true', '2024-10-21'),
    ('흠애호박', 1500, 2.0, 2.0, 'EA', '서치원', '2024-10-18', '2024-11-25', 8, 8, 'true', '2024-10-21'),
    ('키키 양파', 1200, 2.0, 2.0, 'EA', '방민석', '2024-10-19', '2024-12-15', 9, 9, 'true', '2024-10-21'),
    ('덜덜 버섯', 2500, 0.5, 0.5, 'KG', '서치원', '2024-10-20', '2024-11-10', 10, 10, 'true', '2024-10-21');

INSERT INTO material_status_tb (theoretical_amount, actual_amount, status_date, loss, material_id, use_total_amount)
VALUES
    (1.0, 0.95, '2024-10-21', -0.05, 1, 0.0),
    (1.5, 1.49, '2024-10-21', -0.01, 2, 0.0),
    (1.5, 1.45, '2024-10-21', -0.05, 3, 0.0),
    (2.0, 1.43, '2024-10-21', -0.57, 4, 0.0),
    (0.2, 0.19, '2024-10-21', -0.01, 5, 0.0),
    (200.0, 195.0, '2024-10-21', -5.0, 6, 0.0),
    (0.3, 0.29, '2024-10-21', -0.01, 7, 0.0),
    (2.0, 1.95, '2024-10-21', -0.05, 8, 0.0),
    (2.0, 1.9, '2024-10-21', -0.1, 9, 0.0),
    (0.5, 0.48, '2024-10-21', -0.02, 10, 0.0),
    (1.0, 0.95, '2024-10-22', -0.05, 1, 0.0),
    (1.5, 1.49, '2024-10-22', -0.01, 2, 0.0),
    (1.5, 1.45, '2024-10-22', -0.05, 3, 0.0),
    (2.0, 1.43, '2024-10-22', -0.57, 4, 0.0),
    (0.2, 0.19, '2024-10-22', -0.01, 5, 0.0),
    (200.0, 195.0, '2024-10-22', -5.0, 6, 0.0),
    (0.3, 0.29, '2024-10-22', -0.01, 7, 0.0),
    (2.0, 1.95, '2024-10-22', -0.05, 8, 0.0),
    (2.0, 1.9, '2024-10-22', -0.1, 9, 0.0),
    (0.5, 0.48, '2024-10-22', -0.02, 10, 0.0);
--    (1.0, 0.95, '2024-10-28', -0.05, 1),
--    (1.5, 1.49, '2024-10-28', -0.01, 2),
--    (1.5, 1.45, '2024-10-28', -0.05, 3),
--    (2.0, 1.43, '2024-10-28', -0.57, 4),
--    (0.2, 0.19, '2024-10-28', -0.01, 5),
--    (200.0, 195.0, '2024-10-28', -5.0, 6),
--    (0.3, 0.29, '2024-10-28', -0.01, 7),
--    (2.0, 1.95, '2024-10-28', -0.05, 8),
--    (2.0, 1.9, '2024-10-28', -0.1, 9),
--    (0.5, 0.48, '2024-10-28', -0.02, 10);
