INSERT INTO store_tb (name, is_24_hours, is_open, user_id, created_at, allow_minutes, store_address) VALUES

('기가 막히는 한정식', 1, 1, 1, '2023-03-15 12:30:00', 1, '남부청'),
('기가 안막히는 양식', 0, 0, 1, '2023-07-22 09:45:00' ,1, '김부청'),
('Store A', 1, 0, 2, '2023-11-05 14:20:00' ,1, '최부청'),
('Store B', 0, 1, 2, '2024-02-18 11:15:00' ,1, '정부청'),
('Store C', 1, 1, 2, '2024-09-30 08:00:00' ,1, '강부청');
...
INSERT INTO product_tb (id, product_code, name, category, price, store_id) VALUES (5, 115, '돼지국밥', '메인', 7000, 1);
INSERT INTO product_tb (id, product_code, name, category, price, store_id) VALUES (6, 116, '순대국밥', '메인', 7000, 1);
...
VALUES
    ('소금', 111, '상온품', 'KG', 0, 'G', '2025-03-01', 1, 1.1, 'KG'),
    ('김치', 112, '냉장품', 'KG', 0, 'G', '2025-03-02', 1, 2, 'KG'),
    ('돼지고기', 113, '냉동품', 'KG', 0, 'G', '2025-03-03', 1, 0.5, 'KG'),
    ('두부', 114, '냉장품', 'EA', 500.0, 'G', '2025-03-04', 1, 1, 'EA'),
    ('고춧가루', 115, '상온품', 'KG', 0, 'G', '2025-03-05', 1, 100, 'G'),
    ('마늘', 116, '냉장품', 'KG', 0, 'G', '2025-03-06', 1, 50, 'G'),
    ('된장', 117, '냉장품', 'KG', 0, 'G', '2025-03-07', 1, 100, 'G'),
    ('애호박', 118, '냉장품', 'EA', 200.0, 'G', '2025-03-08', 1, 1, 'EA'),
    ('양파', 119, '냉장품', 'EA', 300.0, 'G', '2025-03-09', 1, 1, 'EA'),
    ('버섯', 1110, '냉장품', 'KG', 0, 'G', '2025-03-10', 1, 100, 'G');
...
VALUES
(1.0, 0, 0, '2025-03-22', 1),
(1.5, 0, 0, '2025-03-22', 2),
(1.5, 0, 0, '2025-03-22', 3),
(1.0, 500.0, 0, '2025-03-22', 4),
(0.2, 200, 0, '2025-03-22', 5),
(0.2, 200, 0, '2025-03-22', 6),
(0.3, 300, 0, '2025-03-22', 7),
(2, 400.0, 0, '2025-03-22', 8),
(3, 900.0, 0, '2025-03-22', 9),
(0.5, 500, 0, '2025-03-22', 10);

INSERT INTO material_order_tb (name, price, amount, use_amount , unit, supplier, receipt_date, expiration_date, material_id, adjustment_id, is_use, enter_date)
VALUES
    ('천일염', 1000, 1.0, 1.0, 'KG', '최이제', '2025-03-12', '2025-05-01', 1, 1, 'true', '2025-03-21'),
    ('총각 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2025-03-13', '2025-03-18', 2, 2, 'true', '2025-03-19'),
    ('처녀 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2025-03-14', '2025-04-02', 2, 2, 'true', '2025-03-21'),
    ('아저씨 김치', 5000, 0.5, 0.5, 'KG', '최이제', '2025-03-15', '2025-04-03', 2, 2, 'true', '2025-03-20'),
    ('개쩌는 돼지고기', 15000, 1.5, 1.5, 'KG', '장건우', '2025-03-14', '2025-04-05', 3, 3, 'true', '2025-03-21'),
    ('딱딱 두부', 2000, 1.0, 1.0, 'EA', '장건우', '2025-03-14', '2025-04-01', 4, 4, 'true', '2025-03-21'),
    ('그냥 두부', 2000, 1.0, 1.0, 'EA', '이건우', '2025-03-14', '2025-04-06', 4, 4, 'true', '2025-03-02'),
    ('매운 고춧가루', 3000, 0.1, 0.1, 'KG', '이건우', '2025-03-15', '2025-01-01', 5, 5, 'true', '2025-03-21'),
    ('개매운 고춧가루', 3000, 0.1, 0.1, 'KG', '강경훈', '2025-03-15', '2025-11-01', 5, 5, 'true', '2025-03-21'),
    ('평양 마늘', 1000, 200.0, 200.0, 'G', '김남철', '2025-03-16', '2025-05-15', 6, 6, 'true', '2025-03-21'),
    ('이제 된장', 4000, 0.3, 0.3, 'KG', '방민석', '2025-03-17', '2025-05-20', 7, 7, 'true', '2025-03-21'),
    ('흠애호박', 1500, 2.0, 2.0, 'EA', '서치원', '2025-03-18', '2025-04-25', 8, 8, 'true', '2025-03-21'),
    ('키키 양파', 1200, 2.0, 2.0, 'EA', '방민석', '2025-03-19', '2025-05-15', 9, 9, 'true', '2025-03-21'),
    ('덜덜 버섯', 2500, 0.5, 0.5, 'KG', '서치원', '2025-03-20', '2025-04-10', 10, 10, 'true', '2025-03-21');

INSERT INTO material_status_tb (theoretical_amount, actual_amount, status_date, loss, material_id, use_total_amount)
VALUES
    (1.0, 0.95, '2025-03-21', -0.05, 1, 0.0),
    (1.5, 1.49, '2025-03-21', -0.01, 2, 0.0),
    (1.5, 1.45, '2025-03-21', -0.05, 3, 0.0),
    (2.0, 1.43, '2025-03-21', -0.57, 4, 0.0),
    (0.2, 0.19, '2025-03-21', -0.01, 5, 0.0),
    (200.0, 195.0, '2025-03-21', -5.0, 6, 0.0),
    (0.3, 0.29, '2025-03-21', -0.01, 7, 0.0),
    (2.0, 1.95, '2025-03-21', -0.05, 8, 0.0),
    (2.0, 1.9, '2025-03-21', -0.1, 9, 0.0),
    (0.5, 0.48, '2025-03-21', -0.02, 10, 0.0),
    (1.0, 0.95, '2025-03-22', -0.05, 1, 0.0),
    (1.5, 1.49, '2025-03-22', -0.01, 2, 0.0),
    (1.5, 1.45, '2025-03-22', -0.05, 3, 0.0),
    (2.0, 1.43, '2025-03-22', -0.57, 4, 0.0),
    (0.2, 0.19, '2025-03-22', -0.01, 5, 0.0),
    (200.0, 195.0, '2025-03-22', -5.0, 6, 0.0),
    (0.3, 0.29, '2025-03-22', -0.01, 7, 0.0),
    (2.0, 1.95, '2025-03-22', -0.05, 8, 0.0),
    (2.0, 1.9, '2025-03-22', -0.1, 9, 0.0),
    (0.5, 0.48, '2025-03-22', -0.02, 10, 0.0);
--    (1.0, 0.95, '2025-03-28', -0.05, 1),
--    (1.5, 1.49, '2025-03-28', -0.01, 2),
--    (1.5, 1.45, '2025-03-28', -0.05, 3),
--    (2.0, 1.43, '2025-03-28', -0.57, 4),
--    (0.2, 0.19, '2025-03-28', -0.01, 5),
--    (200.0, 195.0, '2025-03-28', -5.0, 6),
--    (0.3, 0.29, '2025-03-28', -0.01, 7),
--    (2.0, 1.95, '2025-03-28', -0.05, 8),
--    (2.0, 1.9, '2025-03-28', -0.1, 9),
--    (0.5, 0.48, '2025-03-28', -0.02, 10);
