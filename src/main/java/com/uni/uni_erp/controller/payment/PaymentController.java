...
public class PaymentController {
    ...
    public String success(@RequestParam("authKey") String authKey, @RequestParam("customerKey") String customerKey,
        ...
        int userPk = user.getId();
            ...
            try {
                ...
                String desiredPayDate = (String) session.getAttribute("desiredDay");
    ...
    @PostMapping("/setDesiredDay")
    public ResponseEntity<Void> setDesiredDay(@RequestBody Map<String, String> payload, HttpSession session) {
        String desiredDay = payload.get("desiredDay");
        session.setAttribute("desiredDay", desiredDay);
